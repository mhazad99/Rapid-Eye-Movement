...
"""
"""
    Settings viewer of the PolynomialApprox plugin
"""

from qtpy import QtWidgets

from RapidEyeMovementModules.PolynomialApprox.Ui_PolynomialApproxSettingsView import Ui_PolynomialApproxSettingsView
from commons.BaseSettingsView import BaseSettingsView

class PolynomialApproxSettingsView(BaseSettingsView, Ui_PolynomialApproxSettingsView, QtWidgets.QWidget):
    """
        PolynomialApproxView set the PolynomialApprox settings
    """
    ...
    def on_apply_settings(self):
        ...
        # Send the settings to the publisher for inputs to PolynomialApprox

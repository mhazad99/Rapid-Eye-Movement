...
"""
"""
    Results viewer of the DetrendSignal plugin
"""
...
from RapidEyeMovementModules.DetrendSignal.Ui_DetrendSignalResultsView import Ui_DetrendSignalResultsView

class DetrendSignalResultsView(Ui_DetrendSignalResultsView, QtWidgets.QWidget):
    """
        DetrendSignalResultsView nohting to show.
    """
    def __init__(self, parent_node, cache_manager, pub_sub_manager, *args, **kwargs):
        super(DetrendSignalResultsView, self).__init__(*args, **kwargs)

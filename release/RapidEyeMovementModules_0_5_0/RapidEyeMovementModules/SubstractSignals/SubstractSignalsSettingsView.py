...
"""
    Settings viewer of the SubstractSignals plugin
"""

from qtpy import QtWidgets

from RapidEyeMovementModules.SubstractSignals.Ui_SubstractSignalsSettingsView import Ui_SubstractSignalsSettingsView
from commons.BaseSettingsView import BaseSettingsView

class SubstractSignalsSettingsView( BaseSettingsView,  Ui_SubstractSignalsSettingsView, QtWidgets.QWidget):
    """
        SubstractSignalsView display the spectrum from SpectraViewver into
